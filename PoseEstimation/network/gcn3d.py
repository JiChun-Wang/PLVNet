...
class Conv_surface(nn.Module):
    """Extract structure feature from surface, independent from vertices coordinates"""
    ...
    def forward(self,
        ...
        # ss = time.time()
        neighbor_direction_norm = get_neighbor_direction_norm(vertices, neighbor_index) # [bs, v, n, 3]
