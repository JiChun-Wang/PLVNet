...
def test_init_factory_signature(msg):
    ...
    assert msg(excinfo.value) == """
        __init__.py(): incompatible constructor arguments. The following argument types are supported:
    ...
    assert msg(m.TestFactory1.__init__.__doc__) == """
        __init__.py(*args, **kwargs)
        Overloaded function.

        1. __init__.py(self: m.factory_constructors.TestFactory1, arg0: m.factory_constructors.tag.unique_ptr_tag, arg1: int) -> None

        2. __init__.py(self: m.factory_constructors.TestFactory1, arg0: str) -> None

        3. __init__.py(self: m.factory_constructors.TestFactory1, arg0: m.factory_constructors.tag.pointer_tag) -> None

        4. __init__.py(self: m.factory_constructors.TestFactory1, arg0: handle, arg1: int, arg2: handle) -> None
    """  # noqa: E501 line too long
...
def test_invalid_self():
    ...
    for arg in (1, 2):
        with pytest.raises(TypeError) as excinfo:
            BrokenTF1(arg)
        assert str(excinfo.value) == "__init__.py(self, ...) called with invalid `self` argument"
